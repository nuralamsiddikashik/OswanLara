        ...
        <div class="tab-content jump">
            ...
            <div class="tab-pane @if($key == 0) active @endif" id="slide-{{ $slideProductCategory->id }}">
                <div class="row">
                    ...
                    @foreach($slideProductCategory->products()->limit(3)->get() as $product)
                            ...
                            <div class="product-img">
                                ...
                                <div class="product-content-wrapper">
                                    <div class="product-title-spreed">
                                        <h4><a href="{{ route('frontend.single.product',$product->slug)}}">{{ $product->title }}</a></h4>
                                        <span>{{ $product->rpm}}</span>
                                    </div>

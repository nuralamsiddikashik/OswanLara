        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-12">
                <div class="overview-img">
                    <img class="tilter" src="{{ asset('assets/frontend') }}/img/banner/banner-1.png" alt="" style="will-change: transform; transform: perspective(800px) rotateX(0deg) rotateY(0deg);">
                </div>
            </div>
        </div>
    </div>
